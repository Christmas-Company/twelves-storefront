...
import big24 from "@assets/images/ornament-red.webp"
import big25 from "@assets/images/ornament-yellow.webp"
import bn1 from "@assets/images/HZ9_1662.png"
import bn2 from "@assets/images/christmas-decor-inspiration.avif"
                        ...
                        <div className="col-md-4">
                            <Link href="/shop-right-sidebar" className="position-relative hover-zoom d-flex promotion_banner">
                                ...
                                <div className="p-20 position-absolute bottom-0 left-0 text-body">
                                    <p className="text-uppercase text-light fw-medium fs-14 mb-1">View Collections</p>
                                    <h3 className="fs-35 text-light">LOOKBOOK</h3>
                        ...
                        <div className="col-md-4">
                            <Link href="/shop" className="position-relative hover-zoom d-flex promotion_banner kalles-banner-promotion">
                                ...
                                <div className="p-20 position-absolute top-50 end-0 text-body start-0 content-position text-center">
                                    <p className="text-uppercase text-light fw-medium fs-18 mb-1">Men Collection</p>
                                    <h3 className="text-light fs-50">SALE 70%</h3>
                                    <button className="btn btn-dark fw-medium min-w-150 rounded-pill">Shop Now</button>
                                </div>
                            </Link>
                        </div>
                    </div>
