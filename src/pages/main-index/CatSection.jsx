...
import home1 from "@assets/images/1cc.avif"
import home2 from "@assets/images/2cc.webp"
import home3 from "@assets/images/3cc.jpg"
import home4 from "@assets/images/4cc.jpg"
                        ...
                        <Col md={6}>
                            <Link href="/shop-right-sidebar" className="d-block position-relative cat_grid_item overflow-hidden h-624">
                                ...
                                <div className="cat-grid-button text-body">
                                    <div className="cat_grid_item__title">Display</div>
                                </div>
                            </Link>
                        </Col>
